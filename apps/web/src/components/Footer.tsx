      ...
      <Container>
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 text-gray-400">
          <div className="text-sm flex items-center gap-2">
            {versionUrl ? (
              <a href={versionUrl} target="_blank" rel="noopener noreferrer" className="hover:text-gray-600 transition-colors font-mono">
                {versionDisplay}
              </a>
            ) : (
              <span className="font-mono">{versionDisplay}</span>
            )}
            <span>·</span>© 2012-{new Date().getFullYear()} Erv Walter
          </div>
