      ...
      <div className="bg-white">
        <div>
          <div className="lg:grid lg:gap-8 lg:grid-cols-4">
            <div>
              <h1 className="text-gray-900 text-2xl font-extrabold pb-4">
                Frequently asked questions
              </h1>
              <p className="text-base text-gray-500">
                Can't find the answer you're looking for? Email me at <a href="mailto:erv@ewal.net" className="text-brand-600 hover:text-brand-700 underline">erv@ewal.net</a>.
              </p>
            </div>
            <div className="mt-6 lg:mt-0 lg:col-span-3">
              <dl className="space-y-8">
                <Question
                  title="Do I need to have a Withings or Fitbit scale to use this site? Can I manually enter my weight data instead?"
                >
                  <p>
                  ...
                  <p>
                    ...
                    <a href="https://amzn.to/2Rh8yH1" className="text-brand-600 hover:text-brand-700 underline">Withings Scales</a> or <a href="https://amzn.to/3uEWUnS" className="text-brand-600 hover:text-brand-700 underline">Fitbit Scales</a>. (p.s. I'm an Amazon
                    affiliate and receive a small payment if you buy a scale with one of the links on this page)
                  </p>
                  <p>
                    If you don't have a connected scale, just use either the <a href="https://www.withings.com/us/en/health-mate" className="text-brand-600 hover:text-brand-700 underline">Withings Health Mate</a>{" "}
                    app or the <a href="https://www.fitbit.com/sg/app" className="text-brand-600 hover:text-brand-700 underline">Fitbit App</a> and enter your weight manually each day.
                  </p>
                </Question>
                ...
                <Question title="How do I change from Withings to Fitbit (or vice versa)?">
                  <p>
                    ...
                    <Link to="/settings" className="text-brand-600 hover:text-brand-700 underline">settings page</Link> to your new account. TrendWeight will keep all the existing weight data from your old account and
                    combine it with the data from the new one, giving you a unified view of your weight over time.
                  </p>
                </Question>
                ...
                <Question title="Can I share my charts and stats with others?">
                  ...
                  <p>
                    Go to your <Link to="/settings" className="text-brand-600 hover:text-brand-700 underline">Settings</Link> page to find your private URL. You can also change your private URL at any time in case you
                    gave your URL to someone and later decide you don't want them to see your stats anymore.
                  </p>
                </Question>
                <Question title="What is the math behind TrendWeight?">
                  ...
                  <p>
                    Additionally, there is a detailed walkthrough of the math of TrendWeight, specifically in this <a href="#" className="text-brand-600 hover:text-brand-700 underline">blog post</a>.
                  </p>
                </Question>
                <Question title="Is there some way I can help support TrendWeight?">
                  ...
                  <p>
                    ...
                    <Link to="/tipjar" className="text-brand-600 hover:text-brand-700 underline">here</Link>.
                  </p>
                </Question>
                <Question title="Is TrendWeight open source?">
                  <p>
                    Yes. You can find the project on GitHub <a href="https://github.com/trendweight" className="text-brand-600 hover:text-brand-700 underline">here</a>. However, it's essentially a one-man show
                    (me), and I'm pretty protective of the project—probably too overprotective. That said, if you have something you'd like to contribute, please
                    reach out.
                  </p>
                </Question>
                <Question title="I still have a question or a suggestion for a new feature.">
                  <p>
                    No problem. If you have a question you don't see answered here, feel free to email <a href="mailto:erv@ewal.net" className="text-brand-600 hover:text-brand-700 underline">erv@ewal.net</a> and
                    let me know. If you have a suggestion, you can also email that to me, or you can post your idea{" "}
                    <a href="https://github.com/trendweight/trendweight/issues" className="text-brand-600 hover:text-brand-700 underline">here</a>.
                  </p>
                </Question>
              </dl>
            </div>
