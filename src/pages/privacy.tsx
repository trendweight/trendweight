  ...
  return (
    <Box mt={4} maxW="4xl">
      ...
      <Text>
        ...
        <Link href="https://trendweight.io">https://trendweight.io</Link>, and other sites we operate.
      </Text>
      <Text mt={4}>
      ...
      <Text mt={4}>We don’t share any personally identifying information publicly or with third-parties, except when required to by law.</Text>
      <Text mt={4}>
        We use <Link href="https://plausible.io/">Plausible</Link> for analytics to understand how many people visit the site and what kinds of devices they
        ...
        privacy policy <Link href="https://plausible.io/data-policy">here</Link>.
      </Text>
      <Text mt={4}>
        We also use <Link href="https://vercel.com/docs/analytics">Vercel Analytics</Link> to monitor the performance of the app. Vercel also does not use
      ...
      <UnorderedList mt={4} px={4}>
        <ListItem>
          <Link href="https://firebase.google.com/products/auth">Firebase Authentication</Link>. Authenticating accounts e.g. email and password.
        </ListItem>
        <ListItem>
          <Link href="https://firebase.google.com/products/firestore">Firebase Cloud Firestore</Link>. Cloud database for storing your settings and your synced
          weight data.
        </ListItem>
        <ListItem>
          <Link href="https://vercel.com/">Vercel</Link>. Website hosting, content distribution, and performance monitoring.
        </ListItem>
      </UnorderedList>
      <Text mt={4}>
