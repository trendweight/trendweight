            ...
            <Box as="dl" sx={{ "> * + *": { my: 8 } }}>
              ...
              >
                ...
                <Text>
                  ...
                  <Link href="https://amzn.to/2Rh8yH1">Withings Scales</Link> or <Link href="https://amzn.to/3uEWUnS">Fitbit Scales</Link>. (p.s. I'm an Amazon
                  affiliate and receive a small payment if you buy a scale with one of the links on this page)
                </Text>
                <Text>
                  If you don't have a connected scale, just use either the <Link href="https://www.withings.com/us/en/health-mate">Withings Health Mate</Link>{" "}
                  app or the <Link href="https://www.fitbit.com/sg/app">Fitbit App</Link> and enter your weight manually each day.
                </Text>
              </Question>
              <Question title="Is there a mobile app for TrendWeight?">
                <Text>No. The TrendWeight website works great on mobile sizes, and there are no plans for a native mobile app.</Text>
              </Question>
              <Question title="How do I change from Withings to Fitbit (or vice versa)?">
                <Text>
                  ...
                  <Link href="/settings">settings page</Link> to your new account. TrendWeight will keep all the existing weight data from your old account and
              ...
              <Question title="Can I share my charts and stats with others?">
                ...
                <Text>
                  Go to your <Link href="/settings">Settings</Link> page to find your private URL. You can also change your private URL at any time in case you
              ...
              <Question title="What is the math behind TrendWeight?">
                ...
                <Text>
                  Additionally, there is a detailed walkthrough of the math of TrendWeight, specifically in this <Link href="#">blog post</Link>.
                </Text>
              </Question>
              <Question title="Is there some way I can help support TrendWeight?">
                ...
                <Text>
                  ...
                  <Link href="/tipjar">here</Link>.
                </Text>
              </Question>
              <Question title="Is TrendWeight open source?">
                <Text>
                  Yes. You can find the project on GitHub <Link href="https://github.com/trendweight">here</Link>. However, it's essentially a one-man show
              ...
              <Question title="I still have a question or a suggestion for a new feature.">
                <Text>
                  No problem. If you have a question you don't see answered here, feel free to email <Link href="mailto:erv@ewal.net">erv@ewal.net</Link> and
